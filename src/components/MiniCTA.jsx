    ...
    <section className="bg-white text-gray-800 py-20 px-6 text-center font-poppins relative border-t border-gray-100">
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="pt-4 flex flex-col sm:flex-row justify-center gap-4">
          <Link 
            to="/book" 
            className="group/btn relative inline-flex items-center justify-center bg-[#FF914C] hover:bg-[#e07b38] text-white font-bold py-3 px-8 rounded-lg transition-all duration-300 shadow-md hover:shadow-lg hover:-translate-y-0.5 overflow-hidden"
          >
            Book Instant Service
          </Link>
          <a 
            href="mailto:krossovertransport3@gmail.com" 
            className="border-2 border-[#1F628D] text-[#1F628D] hover:bg-[#1F628D] hover:text-white font-bold py-3 px-8 rounded-lg transition-all duration-300"
          >
